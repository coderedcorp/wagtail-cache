...
htmlhelp_basename = 'wagtail-cachedoc'
...
latex_documents = [
    (master_doc, 'wagtail-cache.tex', 'wagtail-cache Documentation',
     'CodeRed LLC', 'manual'),
]
...
man_pages = [
    (master_doc, 'wagtail-cache', 'wagtail-cache Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'wagtail-cache', 'wagtail-cache Documentation',
     author, 'wagtail-cache', 'One line description of project.',
     'Miscellaneous'),
]
